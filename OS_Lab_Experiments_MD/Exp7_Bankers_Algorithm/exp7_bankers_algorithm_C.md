# Banker's Algorithm (Deadlock Avoidance) — Bankers Algorithm (C Program)

## Aim
To write a C program to implement **Bankers Algorithm** as part of the *Banker's Algorithm (Deadlock Avoidance)* experiment.
...
```bash
gcc exp7_bankers_algorithm.c -o exp7_bankers_algorithm
./exp7_bankers_algorithm
```
