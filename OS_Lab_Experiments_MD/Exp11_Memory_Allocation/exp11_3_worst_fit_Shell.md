# Memory Allocation Methods — Worst Fit (Shell Script)

## Aim
To write a shell script to implement **Worst Fit** as part of the *Memory Allocation Methods* experiment.
...
```bash
chmod +x exp11_3_worst_fit.sh
./exp11_3_worst_fit.sh
```
