# Deadlock Detection Algorithm (C Program)

## Aim
To write a C program to implement **Deadlock Detection** as part of the *Deadlock Detection Algorithm* experiment.
...
```bash
gcc exp8_deadlock_detection.c -o exp8_deadlock_detection
./exp8_deadlock_detection
```
