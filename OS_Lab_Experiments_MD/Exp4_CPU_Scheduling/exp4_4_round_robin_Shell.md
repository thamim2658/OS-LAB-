# CPU Scheduling Algorithms — Round Robin (Shell Script)

## Aim
To write a shell script to implement **Round Robin** as part of the *CPU Scheduling Algorithms* experiment.
...
```bash
chmod +x exp4_4_round_robin.sh
./exp4_4_round_robin.sh
```
