# CPU Scheduling Algorithms — SJF (Shell Script)

## Aim
To write a shell script to implement **SJF** as part of the *CPU Scheduling Algorithms* experiment.
