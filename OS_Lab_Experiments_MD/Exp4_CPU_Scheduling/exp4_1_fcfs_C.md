# CPU Scheduling Algorithms — FCFS (C Program)

## Aim
To write a C program to implement **FCFS** as part of the *CPU Scheduling Algorithms* experiment.
...
```bash
gcc exp4_1_fcfs.c -o exp4_1_fcfs
./exp4_1_fcfs
```
