# CPU Scheduling Algorithms — Priority (C Program)

## Aim
To write a C program to implement **Priority** as part of the *CPU Scheduling Algorithms* experiment.
...
```bash
gcc exp4_3_priority.c -o exp4_3_priority
./exp4_3_priority
```
