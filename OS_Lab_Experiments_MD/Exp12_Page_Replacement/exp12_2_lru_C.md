# Page Replacement Algorithms — LRU (C Program)

## Aim
To write a C program to implement **LRU** as part of the *Page Replacement Algorithms* experiment.
...
```bash
gcc exp12_2_lru.c -o exp12_2_lru
./exp12_2_lru
```
